...
5) Modify system unit file /etc/systemd/system/moonraker.service, change mnavarro to your username:
...
That's it, should do it. Further configuration available at: https://docs.mainsail.xyz/setup/manual-setup/mainsail
